...
Está orientado a desplegar un entorno IoT básico que permita recoger los datos de diferentes sensores almacenarlos, analizarlos y generar alertas simples. 
